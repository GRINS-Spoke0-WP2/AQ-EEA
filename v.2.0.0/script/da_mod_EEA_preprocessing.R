...
library(lubridate)
extract_path <-"AQ-EEA/v.2.0.0/data/raw/unzip"
elements_from_zip <- list.files(extract_path)
...
# rm(list = ls())
gc()
source("AQ-EEA/v.2.0.0/script/preprocessing/classify_problematic_rawfiles.R")
...
gc()
EEAfiles <-
  list.files(path = "AQ-EEA/v.2.0.0/data/raw/unzip/E1a",
             pattern = ".csv")
try(load("data/preprocessing/removing_files.Rdata"))
try(load("data/preprocessing/complementary_files.Rdata"))
try(load("data/preprocessing/duplicated_rawfiles.Rdata"))
